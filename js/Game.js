...
showLeaderboard(){
  ...
  showRank(){
    swal({
      ...
      image,Url: "https://raw.githubusercontent.com/vishalgaddam873/p5-multiplayer-car-race-game/master/assets/cup.png",
      imageSize: "100x100",
  ...
  showLife() {
    ...
    fill("white");
    rect(width / 2 - 100, height - player.positionY - 125, 185, 20);
    fill("#f50057");
  ...
  gameOver(){
    ...
    swal({
      ...
      text: "You lose",
      image,Url: "https://cdn.shopify.com/s/files/1/1061/1924/products/Thumbs_Down_Sign_Emoji_Icon_ios10_grande.png",
      imageSize: "100x100",
      confirmButtonText: "Okay"
    })
